...
<Description><![CDATA[Lime.Weixin.MP SDK公众平台官网链接]]></Description>
<Url><![CDATA[http://weixin.Lime.com]]></Url>
<MsgId>1234567890123456</MsgId>
</xml>";
...
<xml>
  ...
  <EventKey><![CDATA[http://weixin.Lime.com]]></EventKey>
</xml>
";
    ...
    <AroundBeacons>
        ...
        public void GetRequestEntityTest()
        {
...

            {
                ...
                Assert.AreEqual("Lime.Weixin.MP SDK公众平台官网链接", result.Description);
                Assert.AreEqual("http://weixin.Lime.com", result.Url);
            }
...

            {
                ...
                Assert.AreEqual("http://weixin.Lime.com", result.EventKey);
            }
