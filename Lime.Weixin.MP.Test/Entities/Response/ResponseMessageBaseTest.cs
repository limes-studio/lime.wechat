...
namespace Lime.Weixin.MP.Test.Entities.Response
{
    [TestClass]
    public class ResponseMessageBaseTest
    {
        ...
        public void CreateFromRequestMessageTest()
        {
            ...
            Assert.AreEqual("Lime", responseMessage.FromUserName);
...
<xml>
  ...
  <Music>
    ...
    <MusicUrl><![CDATA[http://weixin.Lime.com/Content/music1.mp3]]></MusicUrl>
  ...
  <FuncFlag>0</FuncFlag>
                ...
                Assert.AreEqual("http://weixin.Lime.com/Content/music1.mp3", strongResponseMessage.Music.MusicUrl);
...
<xml>
  ...
  <Articles>
    <item>
      ...
      <PicUrl><![CDATA[http://weixin.Lime.com/Images/qrcode.jpg]]></PicUrl>
