...
namespace Lime.Weixin.Open.CommonAPIs
{
    ...
    public static class CommonJsonSend
    {
        ...
        {
            return Lime.Weixin.CommonAPIs.CommonJsonSend.Send(accessToken, urlFormat, data, sendType, timeOut, checkValidationResult, jsonSetting);
        }
