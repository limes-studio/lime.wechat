...
using Lime.Weixin.QY.Entities;
using Lime.Weixin.QY.Helpers;
using Tencent;

namespace Lime.Weixin.QY.MessageHandlers
{
        ...
        where TC : class ,IMessageContext<IRequestMessageBase, IResponseMessageBase>, new()
    {
        ...
        /// 这里是Lime.Weixin.QY，应当在ResponseDocument基础上进行加密（每次获取重新加密，所以结果会不同）
        /// </summary>
