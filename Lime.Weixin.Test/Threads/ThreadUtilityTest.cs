...
using Lime.Weixin.Containers.Tests;
using Lime.Weixin.MessageQueue;

namespace Lime.WeixinTests.Threads
{
    [TestClass]
    public class ThreadUtilityTest
    {
        ...
        public void RunTest()
        {
            //默认情况下ThreadUtility应该已经将LimeMessageQueueThreadUtility加入列队
            //下面对Container进行测试
            ...
            //var mqKey = LimeMessageQueue.GenerateKey("A",typeof(TestContainerBag1), bag.Key,"B");
